  ...
  module EventV1
    module Models
      ...
      class EventExtended < NovacastSDK::BaseModel
        attr_accessor :event_pages, :uid, :user_set_uid, :asset_bundle_uid, :event_sessions, :active_data_set_uid, :public_aliases, :name, :default_session_uid, :page_mappings, :stage
