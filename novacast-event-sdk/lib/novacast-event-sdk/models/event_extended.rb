  ...
  module EventV1
    module Models
      ...
      class EventExtended < NovacastSDK::BaseModel
        attr_accessor :asset_bundle_uid, :uid, :public_aliases, :event_pages, :stage, :name, :active_data_set_uid, :page_mappings, :user_set_uid, :default_session_uid, :event_sessions
