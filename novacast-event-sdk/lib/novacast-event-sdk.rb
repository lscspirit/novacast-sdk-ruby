...
require 'novacast-event-sdk/models/user_comment'
require 'novacast-event-sdk/models/user_comment_list'
require 'novacast-event-sdk/models/user_comment_post_request'
